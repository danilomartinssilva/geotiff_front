...
const LoadComponent = ({
  ...
  <div id="load-tool" className="tool">
    <ToolHeader logoURL="/images/load.svg" title="Load a GeoTIFF" />
    <ToolContent>
      <p className="tool-desc">
        You have two ways to add a GeoTIFF to the map. Add a url or upload a
        file
      </p>
      <br />
      <label htmlFor="basic-url">URL to Your GeoTIFF</label>
      <div className="input-group">
        <input type="text" className="gt-input" onChange={updateURLInput} />
      </div>
      <br />
      <p className="or">
        <b>OR</b>
      ...
      <div className="gt-input">
        <input type="file" onChange={updateFileInput} />
      </div>
